...
python -m debugpy --listen 56306 --wait-for-client $(which vllm) serve /home/y00889327/DSV2LiteWeight \
    ...
    --dbo-prefill-token-threshold 12 \
    --dbo-decode-token-threshold 2 \
    --afd-config '{"afd_connector":"camconnector", "afd_role": "attention", "num_afd_stages":"2","afd_extra_config":{"afd_size":"2A2F"}, "compute_gate_on_attention": "True"}'  |& tee /home/y00889327/workspace-afd/test-vllm-ascend/attn.log